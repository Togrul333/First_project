...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="{{route('admin.makaleler.index')}}" class="btn btn-primary btn-sm float-right">Aktiv makaleler</a>
        </div>
        <div class="card-body">
...
{{--                                </form>--}}
                                <a href="{{route('admin.recover.article',$article->id)}}" type="submit" title="Silmekden kurtar" class="btn btn-sm btn-primary"><i class="fa fa-recycle"></i></a>
                                <a href="{{route('admin.hard.delete.article',$article->id)}}" type="submit" title="Sil" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
