...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link  @if(\Illuminate\Support\Facades\Request::segment(2)=="panel") in @else collapsed @endif " href="#" data-toggle="collapse" data-target="#collapseTwo"
        ...
        <li class="nav-item">
            <a class="nav-link  @if(\Illuminate\Support\Facades\Request::segment(2)=="panel") in @else collapsed @endif " href="#" data-toggle="collapse" data-target="#collapsePage"
            ...
            <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('admin.pages.index')}}">Tum sayfalar</a>
                    <a class="collapse-item" href="{{route('admin.pages.create')}}">Sayfa olustur</a>
                </div>
            </div>
        </li>
...
{{--                    <a  href="{{route('admin.logout')}}">Cikis yap</a>--}}
{{--                </div>--}}
